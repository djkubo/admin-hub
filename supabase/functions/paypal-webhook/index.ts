...
Deno.serve(async (req) => {
  ...
  console.error('❌ paypal-webhook: Webhook disabled until signature verification is configured');
  return new Response(
    JSON.stringify({ 
      error: 'Webhook disabled', 
      code: 'WEBHOOK_DISABLED',
      message: 'PayPal webhook is disabled until signature verification is properly configured. Contact admin.'
    }),

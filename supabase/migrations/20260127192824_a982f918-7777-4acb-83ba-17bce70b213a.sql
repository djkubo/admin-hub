-- =====================================================
-- Eliminar TODAS las versiones anteriores de unify_identity
-- y crear UNA sola versión limpia
-- =====================================================
...
DROP FUNCTION IF EXISTS public.unify_identity(text, text, text, text, text, text, text, text, jsonb, text[], jsonb);
DROP FUNCTION IF EXISTS public.unify_identity(p_source text, p_email text, p_phone text, p_full_name text, p_ghl_contact_id text, p_manychat_subscriber_id text, p_stripe_customer_id text, p_paypal_customer_id text, p_tracking_data jsonb, p_tags text[], p_opt_in jsonb);
DROP FUNCTION IF EXISTS public.unify_identity(p_source text, p_email text, p_phone text, p_full_name text, p_stripe_customer_id text, p_paypal_customer_id text, p_ghl_contact_id text, p_manychat_subscriber_id text, p_tags text[], p_opt_in jsonb, p_tracking_data jsonb);

-- Ahora crear la versión definitiva con orden de parámetros consistente

-- Fix ambiguous column reference in data_quality_checks
...
-- Create webhook_events table for idempotency if not exists
...
CREATE POLICY "Admin can manage webhook_events" ON public.webhook_events

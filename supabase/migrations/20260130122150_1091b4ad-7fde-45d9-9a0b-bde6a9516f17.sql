-- =====================================================
-- MINIMAL Dashboard Metrics - Speed First
-- =====================================================

-- Add index for failed transactions by date
CREATE INDEX IF NOT EXISTS idx_transactions_failed_recent 
ON public.transactions (stripe_created_at DESC, customer_email, amount)
...
AS $$
  ...
  -- ULTRA-FAST: Get top 10 failed transactions, 7 days only
  failed_txs AS (
    SELECT 
      customer_email,
